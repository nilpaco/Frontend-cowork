...
angular.module('coworkApp').controller('ImageDialogController',
    ['$scope', '$stateParams', '$modalInstance', 'entity', 'Image', 'Space',
        function($scope, $stateParams, $modalInstance, entity, Image, Space) {
        ...
        var onSaveFinished = function (result) {
            $scope.$emit('coworkApp:imageUpdate', result);
